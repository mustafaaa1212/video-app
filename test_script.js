// Video Screenshot Extractor - Test Version with Download Links
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkProcessingStatus() {
        ...
        .then(data => {
            if (data.status === 'completed') {
                ...
                showAlert(`
                    Processing complete! Generated ${data.screenshot_count} screenshots.<br>
                    <a href="${downloadLink}" class="btn btn-success btn-sm mt-2">
    ...
    function updateProcessingMessage(data) {
            ...
            statusElement.innerHTML = `
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small>Extracting screenshots using FFmpeg...</small>
                    </div>
                </div>
            `;
        }
